 ...
 */
public class NoteInputListener implements ActionListener{
	 ...
	 */
	public NoteInputListener(CoinReceiver coinReceiver){
	...
	public void actionPerformed(ActionEvent ev){
		NoteButton noteButton=(NoteButton)ev.getSource();
		coinReceiver.receiveNote(noteButton.getNoteWidth());
	}
}//End of class NoteInputListener