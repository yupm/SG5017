 ...
 */
public class NoPayTransactionController extends TransactionController{
	private MainController mainCtrl;
	private NoPayCustomerPanel custPanel;
	 ...
	 */
	public NoPayTransactionController(MainController mainCtrl) {
		super(mainCtrl);
	...
	public void displayCustomerPanel() {
	    ...
	    custPanel = new NoPayCustomerPanel((Frame) scp, this);
		custPanel.display();
